class DishesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dishes_path, notice: "Dish was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def dish_params
      params.expect(dish: [ :name, :description, :category, :price, :rating, :available, :image_names, :bestseller ])
    end
end
